...
class SchoolClass(models.Model):
    ...
    session = models.ForeignKey('schools.AcademicSession', on_delete=models.CASCADE, related_name='classes', null=True, blank=True)
    ...
    class Meta:
        ...
        unique_together = ('name', 'section', 'school', 'session')
